...
<body>
    ...
    // Looping Menaik (Ascending)
    echo "LOOPING PERTAMA <br>";
    for ($i = 2; $i <= 20; $i += 2) {
        echo "$i - I Love PHP <br>";
    }

    // Looping Menurun (Descending)
    ...
    */
    ...
    // Tampilkan array numbers
    echo "Array numbers: ";
    print_r($numbers);

    // Inisialisasi array $rest
    $rest = [];

    // Lakukan looping untuk mencari sisa bagi
    foreach ($numbers as $number) {
        $rest[] = $number % 5; // Menyimpan sisa bagi ke dalam array $rest
    }

    // Tampilkan hasil dari array $rest
    echo "<br><br>Array sisa baginya adalah: ";
    print_r($rest);
    ...
    */
    ...
    // Melakukan looping untuk mengubah setiap item menjadi array asosiatif
    ...
    */
    ...
    // Looping untuk menghasilkan pola bintang
    for ($i = 1; $i <= 5; $i++) { // Loop dari 1 hingga 5
        for ($j = 1; $j <= $i; $j++) { // Loop untuk mencetak bintang per baris
            echo "* "; // Cetak bintang diikuti dengan spasi
        }
